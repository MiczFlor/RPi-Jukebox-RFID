...
class PlayerSpot:
    ...
    def __init__(self):
        ...
        self.http_client.play_uri('spotify:track:4xkOaSrkexMciUUogZKVTS')
...
playerspot_ctrl: PlayerSpot


@plugs.initialize
def initialize():
    global playerspot_ctrl
    playerspot_ctrl = PlayerSpot()
    plugs.register(playerspot_ctrl, name='ctrl')


@plugs.atexit
def atexit(**ignored_kwargs):
    global playerspot_ctrl
    return playerspot_ctrl.exit()
