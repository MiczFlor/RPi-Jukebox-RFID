...
As with the input devices, every output device requires a unique, but
...
Using [GPIOZero\'s remote pins](https://gpiozero.readthedocs.io/en/stable/remote_gpio.html) allows
