...
sudo apt-get --yes --force-yes install python-dev python-pip python-mutagen python-gpiozero
sudo apt-get --yes --force-yes install python3-dev python3-pip python3-mutagen python3-gpiozero
