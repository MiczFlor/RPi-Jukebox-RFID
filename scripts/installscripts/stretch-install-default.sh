...
sudo apt-get update
sudo apt-get --yes --force-yes install apt-transport-https samba samba-common-bin python3-dev python3-pip gcc linux-headers-4.9 lighttpd php7.0-common php7.0-cgi php7.0 php7.0-fpm at mpd mpc mpg123 git ffmpeg python3-mutagen python3-gpiozero
