...
case $COMMAND in 
    ...
    playlistaddplay)
        ...
        # call shuffle_check HERE to enable/disable folder-based shuffeling 
        ...
        # OLD VERSION WITHOUT SINGLE PLAY: mpc load "${VALUE//\//SLASH}" && $PATHDATA/shuffle_play.sh -c=shuffle_check && $PATHDATA/resume_play.sh -c=resume
